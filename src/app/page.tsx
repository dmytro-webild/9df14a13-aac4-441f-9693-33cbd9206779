...
export default function LandingPage() {
  ...
  <div id="about" data-section="about">
      ...
      bulletPoints={[
        {
          title: "UV Resistant",
          description: "Color stability that lasts under direct sunlight.",
        },
        {
          title: "Hypoallergenic",
          description: "Perfect for pollen-sensitive households.",
        },
        {
          title: "Eco-Friendly",
  ...
  <div id="products" data-section="products">
      ...
      products={[
        ...
        },
        {
          ...
          name: "Velvet Rose",
          price: "$75",
          imageSrc: "http://img.b2bpic.net/free-photo/high-angle-pretty-boho-flowers-bouquet_23-2149526049.jpg",
        },
        {
          id: "3",
          name: "Lavender Dream",
          price: "$65",
          imageSrc: "http://img.b2bpic.net/free-photo/beautiful-pink-roses-eustoma-bouquet-old-wooden-shutter-background_23-2147940450.jpg",
        },
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          id: "2",
          name: "Liam K.",
          imageSrc: "http://img.b2bpic.net/free-photo/front-view-woman-posing-indoors_23-2149927580.jpg",
        },
        {
          id: "3",
          name: "Sophia B.",
        ...
        },
        {
          id: "4",
          name: "Oliver T.",
          imageSrc: "http://img.b2bpic.net/free-photo/attractive-african-woman-florist-smiling-making-bouquet-flowers-workplace-white-wall_176420-12267.jpg",
        },
        {
          id: "5",
          name: "Sarah J.",
      ...
      faqs={[
        {
          ...
          content: "Yes, our flowers are made from non-toxic, pet-safe materials.",
        },
        {
          id: "2",
          name: "How do I clean them?",
          content: "Simply wipe with a damp microfiber cloth occasionally.",
        },
        {
          id: "3",
          title: "Do they look fake?",
          content: "Our proprietary molding ensures lifelike details and texture.",
        },
      ]}
